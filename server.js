...
[**invite**](https://discord.com/api/oauth2/authorize?client_id=767679165330751499&permissions=8&scope=bot) **|** [**Support**](https://discord.gg/TffKPGU)  📎
`)
  ...
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
     ...
     .addField('> <a:lod:755109625254379612>  ** PING**' , [`➪ ${Date.now() - message.createdTimestamp}` + ' **ms**'], true)
      ...
      .addField("> <a:651720016651354112:755109590823207043> **DEVLOPER** :  ", `➪ <@668023928739856394>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
